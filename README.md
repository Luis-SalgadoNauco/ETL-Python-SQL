...
Durante esta semana se desarrolla un flujo ETL completo, comenzando por la extracción de datos desde distintas fuentes, continuando con procesos de transformación y enriquecimiento, y finalizando con la carga de datos y el manejo de errores.



El trabajo se realiza de forma incremental, permitiendo comprender cada etapa del proceso y su integración dentro de un pipeline de datos reproducible y documentado.
